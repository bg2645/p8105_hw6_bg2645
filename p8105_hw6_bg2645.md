...
```
  ...
  - I chose variables that are known predictors of infant birthweight.
    ...
    model, all the variables chosen were highly significant.
...
the majority of the residuals fall around 0, however there some values
particularily on the left side of the graph, where the predicted
birthweight is lower, that have very high residuals and thus are
outliers.
...
Based on the three models above, you can see that regmodel\_2 has the
highest RMSE while regmodel\_1 has the lowest RMSE, in which regmodel\_3
has a slightly higher RMSE than regmodel\_1. Thus, regmodel\_1 seems to
be the best model as it has the lowest RMSE and thus fits data better
...
```
  ...
  - Use 5000 bootstrap samples and, for each bootstrap sample, produce
    estimates of rsquared and log(beta0\*beta1).
